...
public class PrefInternal implements PrefInterface {
  ...
  @Override public boolean putDouble(String key, Double value) {
  ...
  @Override public boolean putInt(String key, Integer value) {
  ...
  @Override public List<String> getStringList(String key, List<String> defaultValue) {
    return new ArrayList<>(Arrays.asList(
        getCastObject(key, String[].class, defaultValue.toArray(new String[defaultValue.size()]))));
  }
  ...
  @Override public List<Float> getFloatList(String key, List<Float> defaultValue) {
    return new ArrayList<>(Arrays.asList(
        getCastObject(key, Float[].class, defaultValue.toArray(new Float[defaultValue.size()]))));
  }
  ...
  @Override public List<Double> getDoubleList(String key, List<Double> defaultValue) {
    return new ArrayList<>(Arrays.asList(
        getCastObject(key, Double[].class, defaultValue.toArray(new Double[defaultValue.size()]))));
  }
  ...
  @Override public List<Integer> getIntList(String key, List<Integer> defaultValue) {
    return new ArrayList<>(Arrays.asList(getCastObject(key, Integer[].class,
        defaultValue.toArray(new Integer[defaultValue.size()]))));
  }
  ...
  @Override public List<Boolean> getBooleanList(String key, List<Boolean> defaultValue) {
    return new ArrayList<>(Arrays.asList(getCastObject(key, Boolean[].class,
        defaultValue.toArray(new Boolean[defaultValue.size()]))));
  }
  ...
  @Override public List<Long> getLongList(String key, List<Long> defaultValue) {
    return new ArrayList<>(Arrays.asList(
        getCastObject(key, Long[].class, defaultValue.toArray(new Long[defaultValue.size()]))));
  }

  @Override public <T> boolean putObject(String key, T value) {
    return putString(key, Serialize.toString(value));
  }

  @Override public <T> T getObject(String key, Class<T> tClass) {
    return getCastObject(key, tClass);
  }

  @Override public <T> T getObject(String key, Class<T> tClass, T defaultValue) {
    return getCastObject(key, tClass, defaultValue);
  }

  public Observable<String> listenOn(final String key) {
    return mObservable.filter(new Predicate<String>() {
